...
post1 = Post(
    title='Lançamentos do mês', excerpt='Confira os livros que chegam às prateleiras este mês.', cover='static/img/lançamentos.png'
)

post2 = Post(
    title='Listas e recomendações dos autores', excerpt= '“3 motivos para continuar escrevendo”, “Como criar personagem marcante?”...', cover='static/img/recomendações.png'
)

post3 = Post(
    title='Artigos que inspiram os autores', excerpt='Confira as reflexões, curiosidades e textos curtos que estimulam os autores.', cover='static/img/artigos.png'
)
